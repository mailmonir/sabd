...
//					navToggle(opposite, "hide");					
		...
		*/
		$('body').on('click', '.vd_container', function() {
			if ($(window).width() <= desktop_width){	
				if (!$('body').hasClass('nav-right-hide')){		
					toggleNavbar('right');			
					resizeAffixPanel();						
		...
		$('body').on('click', '[data-action^="remove-navbar"]' , function() {
...
//				$('[data-action^="remove-navbar"]').addClass('active');								
		...
		$('body').on('click', '[data-action^="remove-header"]' ,function() {
//			$(this).siblings().removeClass('active');
			// if remove-navbar state				
...
//				$('[data-action^="remove-header"]').addClass('active');								
		...
		$('body').on('click', '[data-action^="fullscreen"]', function() {
//			$(this).siblings().removeClass('active');
			// if remove-navbar state				
...
//				$('[data-action^="fullscreen"]').addClass('active');								
		...
		$('body').on('click', '[data-action^="boxedtofull"]', function() {
		...
		$('body').on('click', '[data-action^="submenu"]', function() {
			// if submenu state				
