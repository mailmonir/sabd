...
<div class="vd_login-page">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <div class=""> <a href="{{ route('auditor.password.request') }}">Forget Password?</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="register-panel text-center font-semibold"> 
        <a href="{{ route('auditor.register') }}">CREATE AN ACCOUNT<span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a>
    </div>
</div>
