...
<div class="vd_register-page">
    ...
    <div class="panel widget">
        <div class="panel-body">
            <form class="form-horizontal" action="{{ route('auditor.register') }}" role="form" id="register-form" method="post">
            @csrf
            @include('partials.auth.alert')
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="address-input-wrapper">
                            ...
                            <input type="text" placeholder="Company address" class="required" name="address" id="address" value="{{ old('address') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="">
                            ...
                            <input type="email" placeholder="Company email" class="required" required name="email" id="email" value="{{ old('email') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group ">
                    <div class="col-md-12">
                        ...
                        <span class="menu-icon">
                            ...
                            <input type="number" placeholder="Company phone" class="required" required name="phone" id="phone" value="{{ old('phone') }}">
                        </div>
                    </div>
                </div>
                ...
                <div id="vd_login-error" class="alert alert-danger hidden">
                    <i class="fa fa-exclamation-circle fa-fw"></i>{{ __('Please fill the necessary field') }}</div>
                <div class="form-group">
                    <div class="col-md-12 mgbt-xs-10 mgtp-20">
                        <div class="vd_checkbox">
                            <input type="checkbox" id="checkbox-2" {{ old('agree') ? 'checked' : '' }}  name="agree" required value="1">
    ...
    <div class="register-panel text-center font-semibold">{{ __('Already Have an Account?') }}
        <br/>
        <a href="{{route('auditor.login')}}">{{ __('SIGN IN') }}
            <span class="menu-icon">
